export default [
    ...
    {
        name: "Lynx Opaque Ultra",
        details: [
            {
                type: "standard",
                weights: [
                    { value: 100, pricePerUnit: 0.800 },
                    { value: 80, pricePerUnit: 0.650 },
                    { value: 70, pricePerUnit: 0.600 },
    ...
    },
    {
        ...
        details: [
            ...
            },
            {
                type: "Cougar",
                weights: [
                    { value: 100, pricePerUnit: 1.400 },
                    { value: 130, pricePerUnit: 1.750 },
                ],
            },
            {
                type: "LYNX",
                weights: [
                    { value: 100, pricePerUnit: 1.450 },
                    { value: 80, pricePerUnit: 1.125 },
                    { value: 65, pricePerUnit: 0.900 },
                ],
            },
        ],
    },
    ...
    {
        name: "Offset spring TEXT GRAY",
        details: [
            {
                type: "standard",
                weights: [
                    { value: 70, pricePerUnit: 0.500 },
                    { value: 60, pricePerUnit: 0.437 },
                    { value: 50, pricePerUnit: 0.375 },
                ],
            },
        ],
